...
{   
    ...
    questions = [ "Odpowiedz na pytania.", "Comment tu t'appelles ?","Quel âge as-tu ?","Tu habites où ?","Tu parles allemand ?","Tu es polonaise ?" ];
    answers = [ "Zgodnie z podpowiedziami", "Je m'appelle Corinne.","J'ai 23 ans.","J'habite à Bordeaux.","Non, je ne parle pas allemand. Je parle français.","Oui, je suis polonaise." ];
    hints = [ "Expressions de base", "Corinne","23","Bordeaux","Non / français","Oui" ];
